...
namespace Xsjm
{
    public class TestPanel2 : UIBase
    {
        ...
        private void OnBtn5()
        {
            ...
            //UIManager.Instance.Show<tese
        }

        private void OnBtn6()
        {
            Debug.Log(string.Format("Click Btn6"));
            UIManager.Instance.Show<TestPanel3>();
        }

        private void OnBtnClose()
        {
            //UIManager.Instance.Hide<TestPanel2>();
            UIManager.Instance.Destroy<TestPanel2>();
        }
    }
}
